...
const challenge: Challenge = {
  ...
  description: "Write a function to count the total number of nodes in a binary tree. The tree will be a JavaScript object, which denotes child nodes via 'a' and 'b' fields.",
